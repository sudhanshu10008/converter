...
from converter_dict import dictionary as dic
...
class Converter_gui:
    def __init__(self) -> None:
        self.root = tb.Window(title="Converter",size=(720,480))
        
        #converter button frame
        self.left_side_frame = ScrolledFrame(master=self.root,padding=2,name="all",width=180, autohide=True)
